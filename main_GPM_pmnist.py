        ...
        if task_id == 0:
            ...
            for epoch in range(1, args.n_epochs+1):
                ...
                train(args, model, device, xtrain,
                      ytrain, optimizer, criterion)
                clock1 = time.time()
                tr_loss, tr_acc = test(
                    args, model, device, xtrain, ytrain,  criterion)
                ...
                valid_loss, valid_acc = test(
                    args, model, device, xvalid, yvalid,  criterion)
            ...
            test_loss, test_acc = test(
                args, model, device, xtest, ytest,  criterion)
            ...
            for epoch in range(1, args.n_epochs+1):
                # Train
                clock0 = time.time()
                train_projected(args, model, device, xtrain,
                                ytrain, optimizer, criterion, feature_mat)
                clock1 = time.time()
                tr_loss, tr_acc = test(
                    args, model, device, xtrain, ytrain,  criterion)
                print('Epoch {:3d} | Train: loss={:.3f}, acc={:5.1f}% | time={:5.1f}ms |'.format(epoch,
